package br.acerola.manga.local.entity.view

import androidx.room.ColumnInfo
import androidx.room.DatabaseView

@DatabaseView(
    viewName = "manga_summary_view",
    value = """
        SELECT 
        ...
        FROM manga_directory md
        LEFT JOIN manga_metadata mm ON md.id = mm.manga_directory_fk
    """
)
data class MangaSummaryView(
