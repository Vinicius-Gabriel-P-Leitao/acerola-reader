package br.acerola.manga.source.adapter.mangadex.download
...
@Singleton
class MangadexSearchDownloadPort @Inject constructor(
    @param:Mangadex private val chapterDownloadService: ChapterDownloadService,
    @param:Mangadex private val mangaInfoRepo: RemoteInfoOperationsPort<MangaRemoteInfoDto, String>,
) : DownloadPort {
