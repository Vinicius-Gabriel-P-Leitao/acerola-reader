...
class ChapterArchiveAdapterTest {
    ...
    private lateinit var repository: ChapterArchiveAdapter
    ...
    fun setUp() {
        ...
        repository = ChapterArchiveAdapter(directoryDao, chapterArchiveDao, context)
