...
class MangaComicInfoSourceRepositoryTest {
    ...
    fun setUp() {
        ...
        repository = MangaComicInfoSource(context, parser, chapterSourceFactory)
    ...
    @Test
    fun searchInfo_deve_ler_da_raiz_se_ComicInfo_existir() = runTest {
        // Arrange
    ...
    @Test
    fun searchInfo_deve_procurar_dentro_do_cbz_se_nao_houver_xml_na_raiz() = runTest {
        // Arrange
        val folderUri = mockk<Uri>()
        val folderDoc = mockk<DocumentFile>()
    ...
    @Test
    fun searchInfo_deve_retornar_NotFound_se_diretorio_nao_existir() = runTest {
