...
class ComicInfoMangaAdapterTest {
    ...
    @MockK lateinit var downloadCoverService: BinaryOperationsPort<String>
    @MockK lateinit var comicInfoService: RemoteInfoOperationsPort<MangaRemoteInfoDto, String>

    private lateinit var repository: ComicInfoMangaAdapter

    @Before
    fun setUp() {
        MockKAnnotations.init(this)
        repository = ComicInfoMangaAdapter(
