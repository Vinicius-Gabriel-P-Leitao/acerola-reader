...
class MangaRemoteInfoViewModelTest {
    ...
    private val mangaRepo = mockk<MangaPort<MangaRemoteInfoDto>>(relaxed = true)
    private val workManager = mockk<WorkManager>(relaxed = true)
    private val manageCategoriesUseCase = mockk<ManageCategoriesUseCase>(relaxed = true)
    
    private lateinit var observeLibraryUseCase: ObserveLibraryUseCase<MangaRemoteInfoDto>
    ...
    fun setup() {
        ...
        viewModel = MangaRemoteInfoViewModel(observeLibraryUseCase, manageCategoriesUseCase, workManager)
    }
