...
class ObserveHistoryUseCase
    ...
    constructor(
        ...
        operator fun invoke(): Flow<List<ReadingHistoryWithChapterDto>> = historyRepository.getAllRecentHistoryWithChapter()

        fun invokeRecent(): Flow<List<ReadingHistoryDto>> = historyRepository.getAllRecentHistory()
    }
