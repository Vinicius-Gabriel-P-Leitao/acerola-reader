...
import br.acerola.comic.local.translator.infra.ParsedComicInfo
...
class ComicInfoParser @Inject constructor() {
    ...
    fun parseMangaInfo(inputStream: InputStream): Either<ComicInfoError, ComicMetadataDto> = Either.catch {
    ...
    fun serialize(info: ComicMetadataDto): String {
