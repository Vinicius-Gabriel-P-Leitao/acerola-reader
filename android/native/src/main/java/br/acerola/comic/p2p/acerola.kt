...
internal interface UniffiLib : Library {
    ...
    fun uniffi_acerola_fn_constructor_p2pnode_new(`callback`: Pointer,`dataDir`: RustBuffer.ByValue,`relayUrl`: RustBuffer.ByValue,`deviceName`: RustBuffer.ByValue,`deviceVersion`: RustBuffer.ByValue,`historyProvider`: Pointer,`fileProvider`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_acerola_checksum_constructor_p2pnode_new() != 1628.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
open class P2pNode: Disposable, AutoCloseable, P2pNodeInterface {
    ...
    constructor(`callback`: P2pCallback, `dataDir`: kotlin.String, `relayUrl`: kotlin.String?, `deviceName`: kotlin.String, `deviceVersion`: kotlin.String, `historyProvider`: HistorySyncProvider, `fileProvider`: FileSyncProvider) :
        this(
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_acerola_fn_constructor_p2pnode_new(
        FfiConverterTypeP2PCallback.lower(`callback`),FfiConverterString.lower(`dataDir`),FfiConverterOptionalString.lower(`relayUrl`),FfiConverterString.lower(`deviceName`),FfiConverterString.lower(`deviceVersion`),FfiConverterTypeHistorySyncProvider.lower(`historyProvider`),FfiConverterTypeFileSyncProvider.lower(`fileProvider`),_status)
}
    )
