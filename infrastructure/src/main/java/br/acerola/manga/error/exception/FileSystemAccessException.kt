...
class FileSystemAccessException(
    @param:StringRes override val title: Int = R.string.title_file_system_access_error,
    @param:StringRes override val description: Int = R.string.description_file_system_access_error,
