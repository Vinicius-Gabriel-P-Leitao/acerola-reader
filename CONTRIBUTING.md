...
- **Escopo por PR**: um PR deve tocar uma única plataforma (`android/`, `desktop/`, `lib/p2p/` ou `relay/`), salvo mudanças de fato compartilhadas (docs raiz, `LICENSE`, `PRIVACY_POLICY.md`).
