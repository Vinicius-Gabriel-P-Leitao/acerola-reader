...
sealed interface ValidationError : UserMessage {
    ...
    data class InvalidFormat(
        ...
        override val uiMessage =
            UiText.StringResource(
                resId = R.string.validation_invalid_format,
                args = listOf(field),
            )
    }
    ...
    data class OutOfRange(
        ...
        override val uiMessage =
            UiText.StringResource(
                resId = R.string.validation_out_of_range,
                args = listOf(field, min, max, actual),
            )
    }
    ...
    data class TooShort(
        ...
        override val uiMessage =
            UiText.StringResource(
                resId = R.string.validation_too_short,
                args = listOf(field, minLength),
            )
    }
    ...
    data class TooLong(
        ...
        override val uiMessage =
            UiText.StringResource(
                resId = R.string.validation_too_long,
                args = listOf(field, maxLength),
            )
    }
}
